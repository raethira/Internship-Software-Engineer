                                ...
                                <tr>
                                    <td align="justify">
                                        <div align="justify">
                                            ...
                                            <br />1.	Receiving/Sending/organizing ONGC FORMS.
                                            <br />2.	Sending form using send form.
                                            <br />3.    Address book capability
                                            <br />4.	Organize forms in Logical Folders
                                            ...
                                            <td colspan="3"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" style="font-weight: bold; color: #ffffff">
                                                        <asp:TextBox ID="txtUserName" runat="server" ValidationGroup="g1"></asp:TextBox><font color="black">@Spicemail.com<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserName"
